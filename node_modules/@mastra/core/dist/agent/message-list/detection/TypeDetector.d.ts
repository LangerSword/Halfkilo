import type { Message as AIV4Message, UIMessage as UIMessageV4 } from '../../../_types/@internal_ai-sdk-v4/dist/index.js';
import type { MastraDBMessage, MastraMessageV1 } from '../state/types.js';
import type { AIV5Type, AIV6Type, CoreMessageV4 } from '../types.js';
/**
 * Type representing all possible message input formats
 */
export type MessageInput = AIV6Type.UIMessage | AIV6Type.ModelMessage | AIV5Type.UIMessage | AIV5Type.ModelMessage | (UIMessageV4 & {
...
export declare class TypeDetector {
     ...
     */
    static hasAIV6UIMessageCharacteristics(msg: AIV6Type.UIMessage | AIV5Type.UIMessage | UIMessageV4 | AIV4Message): msg is AIV6Type.UIMessage;
    /**
     ...
     */
    static hasAIV5UIMessageCharacteristics(msg: AIV6Type.UIMessage | AIV5Type.UIMessage | UIMessageV4 | AIV4Message): msg is AIV5Type.UIMessage;
    /**
     * Check if a message has AIV6-only core characteristics.
     */
    static hasAIV6CoreMessageCharacteristics(msg: CoreMessageV4 | AIV5Type.ModelMessage | AIV6Type.ModelMessage | AIV4Message): msg is AIV6Type.ModelMessage;
    /**
     ...
     */
    static hasAIV5CoreMessageCharacteristics(msg: CoreMessageV4 | AIV6Type.ModelMessage | AIV5Type.ModelMessage | AIV4Message): msg is AIV5Type.ModelMessage;
    /**
