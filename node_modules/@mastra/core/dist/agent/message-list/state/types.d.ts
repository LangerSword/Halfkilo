...
export type MastraMessagePart = PartWithProviderMetadata<Exclude<UIMessageV4['parts'][number], {
    type: 'tool-invocation' | 'source';
}>> | MastraToolInvocationPart | MastraSourceUrlPart | MastraSourceDocumentPart | PartWithProviderMetadata<AIV5Type.DataUIPart<AIV5.UIDataTypes>>;
