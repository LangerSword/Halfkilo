...
export declare function createPrepareToolsStep<OUTPUT = undefined>({ capabilities, options, threadFromArgs, resourceId, runId, requestContext, agentSpan, methodType, memory: _memory, }: PrepareToolsStepOptions<OUTPUT>): import("../../../workflows").Step<"prepare-tools-step", unknown, Record<string, never>, {
