...
var chunkTSAH7BD4_cjs = require('./chunk-TSAH7BD4.cjs');
var chunkRFARTLSL_cjs = require('./chunk-RFARTLSL.cjs');
var chunkF3QBBJBD_cjs = require('./chunk-F3QBBJBD.cjs');
var chunk26ZXSSBE_cjs = require('./chunk-26ZXSSBE.cjs');
var chunkXEM4OYJI_cjs = require('./chunk-XEM4OYJI.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkXEM4OYJI_cjs.createStreamFromGenerateResult(result)
    };
  }
...
chunkBVWXTWXP_cjs.__export(dist_exports, {
  ...
  EventSourceParserStream: () => chunk26ZXSSBE_cjs.EventSourceParserStream,
  VERSION: () => VERSION,
  asSchema: () => asSchema,
...
var _a;
var _b;
var DownloadError = class extends (_b = chunk26ZXSSBE_cjs.AISDKError, _a = symbol, _b) {
  constructor({
    url,
    statusCode,
    statusText,
  ...
  static isInstance(error) {
    return chunk26ZXSSBE_cjs.AISDKError.hasMarker(error, marker);
  }
};
...
var createIdGenerator = ({
  ...
  if (alphabet.includes(separator)) {
    throw new chunk26ZXSSBE_cjs.InvalidArgumentError({
      argument: "separator",
...
function handleFetchError({
  ...
  if (error instanceof TypeError && FETCH_FAILED_ERROR_MESSAGES.includes(error.message.toLowerCase())) {
    ...
    if (cause != null) {
      return new chunk26ZXSSBE_cjs.APICallError({
  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        ...
        if (isAbortError(error) || chunk26ZXSSBE_cjs.APICallError.isInstance(error)) {
          throw error;
        }
...
function loadApiKey({
  ...
  if (apiKey != null) {
    throw new chunk26ZXSSBE_cjs.LoadAPIKeyError({
...
function loadSetting({
  ...
  if (settingValue != null) {
    throw new chunk26ZXSSBE_cjs.LoadSettingError({
...
function standardSchemaValidator(standardSchema) {
  return validator(async (value) => {
    ...
    return result.issues == null ? { success: true, value: result.value } : {
      success: false,
      error: new chunk26ZXSSBE_cjs.TypeValidationError({
        value,
        cause: result.issues
      })
    };
...
async function validateTypes({
  ...
  if (!result.success) {
    throw chunk26ZXSSBE_cjs.TypeValidationError.wrap({ value, cause: result.error });
  }
  return result.value;
}
async function safeValidateTypes({
  ...
  try {
    ...
    return {
      success: false,
      error: chunk26ZXSSBE_cjs.TypeValidationError.wrap({ value, cause: result.error }),
      rawValue: value
    };
  } catch (error) {
    return {
      success: false,
      error: chunk26ZXSSBE_cjs.TypeValidationError.wrap({ value, cause: error }),
      rawValue: value
    };
  }
}
async function parseJSON({
  ...
  try {
    ...
    if (chunk26ZXSSBE_cjs.JSONParseError.isInstance(error) || chunk26ZXSSBE_cjs.TypeValidationError.isInstance(error)) {
      throw error;
    }
    throw new chunk26ZXSSBE_cjs.JSONParseError({ text, cause: error });
  }
}
async function safeParseJSON({
  ...
  try {
    ...
    return {
      success: false,
      error: chunk26ZXSSBE_cjs.JSONParseError.isInstance(error) ? error : new chunk26ZXSSBE_cjs.JSONParseError({ text, cause: error }),
      rawValue: void 0
    };
  }
}
...
function parseJsonEventStream({
  ...
  return stream.pipeThrough(new TextDecoderStream()).pipeThrough(new chunk26ZXSSBE_cjs.EventSourceParserStream()).pipeThrough(
    new TransformStream({
...
var createJsonErrorResponseHandler = ({
  ...
  if (responseBody.trim() === "") {
    return {
      responseHeaders,
      value: new chunk26ZXSSBE_cjs.APICallError({
...
var createEventSourceResponseHandler = (chunkSchema) => async ({ response }) => {
  ...
  if (response.body == null) {
    throw new chunk26ZXSSBE_cjs.EmptyResponseBodyError({});
  }
  return {
    responseHeaders,
...
function parseArrayDef(def, refs) {
  ...
  if (((_a2 = def.type) == null ? void 0 : _a2._def) && ((_c = (_b2 = def.type) == null ? void 0 : _b2._def) == null ? void 0 : _c.typeName) !== v3.ZodFirstPartyTypeKind.ZodAny) {
...
function parseRecordDef(def, refs) {
  ...
  if (((_b2 = def.keyType) == null ? void 0 : _b2._def.typeName) === v3.ZodFirstPartyTypeKind.ZodString && ((_c = def.keyType._def.checks) == null ? void 0 : _c.length)) {
...
`;
  ...
  for (const { role, content } of prompt) {
    switch (role) {
      case "system": {
        throw new chunk26ZXSSBE_cjs.InvalidPromptError({
...
var AzureOpenAIGateway = class extends chunk26ZXSSBE_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
    this.validateConfig();
  ...
  async resolveLanguageModel({
    ...
    return createAzure({
      ...
      headers: { "User-Agent": chunk26ZXSSBE_cjs.MASTRA_USER_AGENT, ...headers }
    })(modelId);
  }
};
...
function getStaticProvidersByGateway(name2) {
  return Object.fromEntries(Object.entries(chunkTSAH7BD4_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name2));
}
var defaultGateways = [
  new chunkF3QBBJBD_cjs.NetlifyGateway(),
  new chunkTSAH7BD4_cjs.MastraGateway(),
  new chunkRFARTLSL_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))
];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const parsed = chunkRFARTLSL_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    ...
    try {
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkRFARTLSL_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkXEM4OYJI_cjs.AISDKV5LanguageModel(model);
  ...
  async resolveLanguageModel({
    ...
    if (this.config.url) {
      const modelInstance2 = chunk26ZXSSBE_cjs.createOpenAICompatible({
        name: providerId,
        apiKey,
  ...
  resolveOpenAIWebSocketModel({
    ...
    const modelInstance = chunk26ZXSSBE_cjs.createOpenAI({
      apiKey,
      baseURL,
      headers,
      fetch: wsFetch
...
async function resolveModelConfig(modelConfig, requestContext = new chunk5WBEMKE2_cjs.RequestContext(), mastra) {
  if (typeof modelConfig === "function") {
    modelConfig = await modelConfig({ requestContext, mastra });
  }
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof chunkXEM4OYJI_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkXEM4OYJI_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.url) {
      ...
      this.providerModel = chunk26ZXSSBE_cjs.createOpenAICompatible({
      ...
      const registry = chunkTSAH7BD4_cjs.GatewayRegistry.getInstance();
      ...
      if (normalizedConfig.providerId === "openai") {
        this.providerModel = chunk26ZXSSBE_cjs.createOpenAI({ apiKey }).textEmbeddingModel(
          normalizedConfig.modelId
        );
      } else if (normalizedConfig.providerId === "google") {
        this.providerModel = chunk26ZXSSBE_cjs.createGoogleGenerativeAI({ apiKey }).textEmbedding(
          normalizedConfig.modelId
        );
      } else {
...
//# sourceMappingURL=chunk-5POWUC5M.cjs.map
//# sourceMappingURL=chunk-5POWUC5M.cjs.map