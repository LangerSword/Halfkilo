...
var NetlifyGateway = class extends chunk26ZXSSBE_cjs.MastraModelGateway {
  id = "netlify";
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      case "openai":
        return chunk26ZXSSBE_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).responses(modelId);
      case "gemini":
        return chunk26ZXSSBE_cjs.createGoogleGenerativeAI({
...
//# sourceMappingURL=chunk-F3QBBJBD.cjs.map
//# sourceMappingURL=chunk-F3QBBJBD.cjs.map