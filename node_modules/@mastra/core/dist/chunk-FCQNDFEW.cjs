...
var MastraBase = class {
  component = chunk7GW2TQXP_cjs.RegisteredLogger.LLM;
  logger;
  name;
  #rawConfig;
  constructor({
    ...
    this.component = component || chunk7GW2TQXP_cjs.RegisteredLogger.LLM;
    this.name = name;
    this.#rawConfig = rawConfig;
    this.logger = new chunk7GW2TQXP_cjs.ConsoleLogger({ name: `${this.component} - ${this.name}` });
  }
  /**
...
//# sourceMappingURL=chunk-FCQNDFEW.cjs.map
//# sourceMappingURL=chunk-FCQNDFEW.cjs.map