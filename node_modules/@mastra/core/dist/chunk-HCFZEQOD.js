import { ModelsDevGateway, createOpenRouter } from './chunk-RJXIBFWM.js';
import { NetlifyGateway } from './chunk-PVBMRGDA.js';
import { MastraModelGateway, createAnthropic, MASTRA_USER_AGENT, GATEWAY_AUTH_HEADER } from './chunk-GYRJZMNH.js';
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-6G5YAXMB.js');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-U7FEFJEC.js');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-F5NHIZT4.js');
...
//# sourceMappingURL=chunk-HCFZEQOD.js.map
//# sourceMappingURL=chunk-HCFZEQOD.js.map