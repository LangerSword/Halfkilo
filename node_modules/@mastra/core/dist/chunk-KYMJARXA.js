import { WorkflowEventProcessor } from './chunk-4RGVQ5CO.js';
import { isToolLoopAgentLike, toolLoopAgentToMastraAgent } from './chunk-PI6G5HKZ.js';
import { initContextStorage } from './chunk-EGIEQEHP.js';
import { DatasetsManager } from './chunk-WGOLVEGM.js';
import { createOnScorerHook } from './chunk-3GZBQLYX.js';
import { augmentWithInit } from './chunk-4TUIZXRS.js';
import { EventEmitterPubSub } from './chunk-X2HAI3OX.js';
import { registerHook } from './chunk-L54GIUCB.js';
import { defaultGateways } from './chunk-QWTELAMT.js';
import { DualLogger, noopLogger } from './chunk-MZJQ7OKW.js';
import { InMemoryServerCache } from './chunk-HQXVBGBM.js';
import { NoOpObservability, noOpLoggerContext, noOpMetricsContext } from './chunk-V2HSN7VZ.js';
...
var Mastra = class {
  ...
  #syncGatewayRegistry() {
    try {
      ...
      import('./provider-registry-YLBLTJRK.js').then(async ({ GatewayRegistry }) => {
...
export { Mastra };
//# sourceMappingURL=chunk-KYMJARXA.js.map
//# sourceMappingURL=chunk-KYMJARXA.js.map