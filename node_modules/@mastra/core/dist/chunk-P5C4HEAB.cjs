...
var scoringEntityTypeSchema = v4.z.enum(["AGENT", "WORKFLOW", ...Object.values(chunkL56725IW_cjs.SpanType)]);
...
var scoreRowDataSchema = v4.z.object({
  ...
  // Timestamps
  ...chunkL56725IW_cjs.dbTimestamps
});
...
var listScoresResponseSchema = v4.z.object({
  pagination: chunkL56725IW_cjs.paginationInfoSchema,
...
var spanTypeField = v4.z.nativeEnum(chunkL56725IW_cjs.SpanType).describe("Span type (e.g., WORKFLOW_RUN, AGENT_RUN, TOOL_CALL, etc.)");
...
var sharedFields = {
  ...chunkL56725IW_cjs.spanContextFields,
  metadata: chunkL56725IW_cjs.metadataField.nullish(),
  tags: chunkL56725IW_cjs.tagsField.nullish()
};
var spanIds = {
  traceId: chunkL56725IW_cjs.traceIdField,
  spanId: chunkL56725IW_cjs.spanIdField
};
var spanIdsSchema = v4.z.object({
  ...spanIds
});
var omitDbTimestamps = createOmitKeys(chunkL56725IW_cjs.dbTimestamps);
...
var getSpanArgsSchema = v4.z.object({
  traceId: chunkL56725IW_cjs.traceIdField.min(1),
  spanId: chunkL56725IW_cjs.spanIdField.min(1)
...
var tracesFilterSchema = v4.z.object({
  // Date range filters
  startedAt: chunkL56725IW_cjs.dateRangeSchema.optional().describe("Filter by span start time range"),
  endedAt: chunkL56725IW_cjs.dateRangeSchema.optional().describe("Filter by span end time range"),
  // Span type filter
...
var tracesOrderBySchema = v4.z.object({
  ...
  direction: chunkL56725IW_cjs.sortDirectionSchema.default("DESC").describe("Sort direction")
}).describe("Order by configuration");
var listTracesArgsSchema = v4.z.object({
  filters: tracesFilterSchema.optional().describe("Optional filters to apply"),
  pagination: chunkL56725IW_cjs.paginationArgsSchema.default({ page: 0, perPage: 10 }).describe("Pagination settings"),
...
var batchDeleteTracesArgsSchema = v4.z.object({
  traceIds: v4.z.array(chunkL56725IW_cjs.traceIdField)
...
var scoreTracesRequestSchema = v4.z.object({
  ...
  targets: v4.z.array(
    v4.z.object({
      traceId: chunkL56725IW_cjs.traceIdField,
      spanId: chunkL56725IW_cjs.spanIdField.optional()
    })
  ).min(1)
});
...
//# sourceMappingURL=chunk-P5C4HEAB.cjs.map
//# sourceMappingURL=chunk-P5C4HEAB.cjs.map