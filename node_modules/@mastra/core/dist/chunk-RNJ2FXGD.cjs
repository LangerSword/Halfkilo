...
function isLSPAvailable() {
  ...
  try {
    const req = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-RNJ2FXGD.cjs', document.baseURI).href)));
...
function createSkillTool(skills) {
  const tool = chunkLDLHW3QN_cjs.createTool({
    id: "skill",
...
var astEditTool = chunkLDLHW3QN_cjs.createTool({
...
var deleteFileTool = chunkLDLHW3QN_cjs.createTool({
...
var executeCommandTool = chunkLDLHW3QN_cjs.createTool({
...
var executeCommandWithBackgroundTool = chunkLDLHW3QN_cjs.createTool({
  id: WORKSPACE_TOOLS.SANDBOX.EXECUTE_COMMAND,
  description: `${baseDescription}
...
var fileStatTool = chunkLDLHW3QN_cjs.createTool({
  ...
  execute: async ({ path: path9 }, context) => {
    ...
    try {
      ...
      span.end({ success: true }, { bytesTransferred: stat3.size });
      return parts.join(" ");
    } catch (error) {
      if (error instanceof FileNotFoundError) {
        span.end({ success: false });
...
var getProcessOutputTool = chunkLDLHW3QN_cjs.createTool({
...
var grepTool = chunkLDLHW3QN_cjs.createTool({
...
var indexContentTool = chunkLDLHW3QN_cjs.createTool({
...
var killProcessTool = chunkLDLHW3QN_cjs.createTool({
...
var listFilesTool = chunkLDLHW3QN_cjs.createTool({
...
To list ALL files, omit the pattern parameter \u2014 do NOT pass pattern: "*".`,
  ...
  execute: async ({ path: path9 = ".", maxDepth = 2, showHidden, dirsOnly, exclude, extension, pattern, respectGitignore }, context) => {
    ...
    const span = startWorkspaceSpan(context, workspace, {
      category: "filesystem",
      operation: "listFiles",
      input: { path: path9, maxDepth, pattern },
      attributes: { filesystemProvider: filesystem.provider }
    });
    try {
...
var lspInspectTool = chunkLDLHW3QN_cjs.createTool({
...
var mkdirTool = chunkLDLHW3QN_cjs.createTool({
...
var searchTool = chunkLDLHW3QN_cjs.createTool({
...
var writeFileTool = chunkLDLHW3QN_cjs.createTool({
...
//# sourceMappingURL=chunk-RNJ2FXGD.cjs.map
//# sourceMappingURL=chunk-RNJ2FXGD.cjs.map