...
var MastraGateway = class extends chunk26ZXSSBE_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
  }
  ...
  resolveLanguageModel({
    ...
    if (this.config?.customFetch && providerId === "anthropic") {
      return chunk26ZXSSBE_cjs.createAnthropic({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunk26ZXSSBE_cjs.MASTRA_USER_AGENT,
          [chunk26ZXSSBE_cjs.GATEWAY_AUTH_HEADER]: `Bearer ${apiKey}`,
          ...headers
        },
    ...
    if (this.config?.customFetch) {
      return chunkRFARTLSL_cjs.createOpenRouter({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunk26ZXSSBE_cjs.MASTRA_USER_AGENT,
...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-TSAH7BD4.cjs', document.baseURI).href)) || "file://");
...
function loadRegistry(useDynamicLoading, customGateways = []) {
  const enabledGatewayIds = getEnabledGatewayIds([
    new chunkRFARTLSL_cjs.ModelsDevGateway({}),
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-VFHWG4YA.cjs');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-MGGY5TEN.cjs');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-UZMVHX5W.cjs');
...
//# sourceMappingURL=chunk-TSAH7BD4.cjs.map
//# sourceMappingURL=chunk-TSAH7BD4.cjs.map