...
var MastraLLMV1 = class extends chunkFCQNDFEW_cjs.MastraBase {
  ...
  async __text({
    ...
    const model = this.#model;
    const observabilityContext = chunk4FFOOHE5_cjs.resolveObservabilityContext(rest);
    ...
    if (experimental_output) {
      ...
      if (chunkXS3FHQ34_cjs.isZodType(experimental_output)) {
    ...
    const argsForExecute = {
      ...
      onStepFinish: async (props) => {
        ...
        if (!isNaN(remainingTokens) && remainingTokens > 0 && remainingTokens < 2e3) {
          ...
          await chunkXS3FHQ34_cjs.delay(10 * 1e3);
        }
      },
    ...
    try {
      const result = await chunkQFGYBEP3_cjs.executeWithContext({
        span: llmSpan,
  ...
  async __textObject({
    ...
    try {
      ...
      try {
        const result = await chunkSQINVD7G_cjs.generateObject(argsForExecute);
        llmSpan?.end({
          output: {
            object: result.object,
            warnings: result.warnings
  ...
  __stream({
    ...
    if (llmSpan) {
      chunkQFGYBEP3_cjs.executeWithContextSync({
        span: llmSpan,
    ...
    try {
      return chunkQFGYBEP3_cjs.executeWithContextSync({ span: llmSpan, fn: () => chunkSQINVD7G_cjs.streamText(argsForExecute) });
    } catch (e) {
      const mastraError = new chunk4U7ZLI36_cjs.MastraError(
        {
  ...
  __streamObject({
    ...
    try {
      ...
      try {
        return chunkSQINVD7G_cjs.streamObject(argsForExecute);
      } catch (e) {
        const mastraError = new chunk4U7ZLI36_cjs.MastraError(
          {
...
//# sourceMappingURL=chunk-XEM4OYJI.cjs.map
//# sourceMappingURL=chunk-XEM4OYJI.cjs.map