...
function isToolLoopAgentLike(obj) {
  if (!obj) return false;
  if (obj instanceof chunkMMHYKJDT_cjs.ToolLoopAgent) return true;
  ...
  async handlePrepareStep(args, currentResult) {
    if (this.settings.prepareStep) {
      ...
      if (currentResult.model) {
        const resolvedModel = await chunk5POWUC5M_cjs.resolveModelConfig(currentResult.model);
        if (!chunkZYCSOEMD_cjs.isSupportedLanguageModel(resolvedModel)) {
...
function toolLoopAgentToMastraAgent(agent, options) {
  ...
  return new chunkZYCSOEMD_cjs.Agent({
    ...agentConfig,
    id,
...
//# sourceMappingURL=chunk-ZMGEKD6A.cjs.map
//# sourceMappingURL=chunk-ZMGEKD6A.cjs.map