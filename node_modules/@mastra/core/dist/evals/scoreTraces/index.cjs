...
var getTraceStep = chunkIQH7JT26_cjs.createStep({
...
async function runScorerOnTarget({
  ...
  const result = await scorer.run({
    ...
    scoreSource: "trace",
    targetScope: "span",
    targetEntityType: chunkQFGYBEP3_cjs.getEntityTypeForSpan(span),
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunkP5C4HEAB_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkIQH7JT26_cjs.createWorkflow({
