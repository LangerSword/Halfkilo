...
import type { StandardSchemaWithJSON, InferStandardSchemaOutput, ZodSchema } from '../../schema/index.js';
import type { ScoringData } from './base.types.js';
import type { ModelRouterModelId } from './provider-registry.js';
export type inferOutput<Output extends StandardSchemaWithJSON | ZodSchema | JSONSchema7 | undefined = undefined> = Output extends StandardSchemaWithJSON ? InferStandardSchemaOutput<Output> : Output extends ZodSchema ? z.infer<Output> : Output extends JSONSchema7 ? unknown : undefined;
